...
const Blogs = () => {
  ...
  return (
    <div className='w-11/12 max-w-[670px] h-screen py-1 flex flex-col gap-y-1 mt-[50px] mb-[50px]  justify-center items-center'>
    {
        ...
        (   
            ...
            (posts.map( (post) => (
                ...
                <div key={post.id}>
                    ...
                    <p className='text-sm mt-[7px]'>{post.content}</p>
